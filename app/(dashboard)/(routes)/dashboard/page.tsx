...
const tools = [
  ...
  { label: 'Video Generation', href: '/video', icon: VideoIcon, color: "text-emerald-500", bgColor: "bg-emerald-500/10" },
  { label: 'Music Generation', href: '/music', icon: MusicIcon, color: "text-orange-700", bgColor: "bg-orange-700/10" },
