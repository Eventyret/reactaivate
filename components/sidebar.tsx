...
const routes = [
  ...
  { label: 'Video Generation', href: '/video', icon: VideoIcon, color: "text-emerald-500" },
  { label: 'Music Generation', href: '/music', icon: MusicIcon, color: "text-orange-700" },
    ...
    <div className='space-y-4 py-4 flex flex-col h-full bg-[#111827] text-white'>
      <div className='flex-1 px-3 py-2'>
        ...
        <div className='space-y-1'>
          {routes.map((route) => (
            <Link href={route.href} key={route.href} className='flex justify-start w-full p-3 text-sm font-medium transition rounded-lg cursor-pointer group hover:text-white hover:bg-white/10'>
